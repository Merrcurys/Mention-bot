...
## О боте
Mention bot — telegram-бот, который может оповещать всех пользователей в чате. Бот может присылать уведомления всем или только администраторам в группах до 75 участников. Все логи анонимны, создатель и тех.поддержка не знает о ваших чатах ничего.
